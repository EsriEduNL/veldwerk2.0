      ...
      <div class="row">
        ...
        <div class="col-xs-12">
          ...
          <div class="selected-webmap-groups thumbnail">
            <button type="button" class="btn btn-default" data-toggle="modal" data-target="#modal-add-group">Groep toevoegen</button>
            <button type="button" class="btn btn-default btn-goto-add-users" data-toggle="modal" data-target="#modal-add-users">Gebruiker(s) toevoegen</button>
            <button type="button" class="btn btn-default" data-toggle="modal" data-target="#modal-add-groups">Groep toevoegen in bulk</button>
                ...
                <div class="row">
                  ...
                  <div class="col-xs-6">
                    ...
                    <div class="input-group custom-search-form" id="groups-aol-search">
                      <input type="text" class="form-control listSearch" data-listSearch="assiningUsersToGroupGroups">
                      <span class="input-group-btn">
                        <button class="btn btn-default" type="button">
                          <span class="glyphicon glyphicon-search"></span>
                        </button>
                  ...
                  <div class="col-xs-6 with-bg-grey">
                    <label>Alle gebruikers</label>
                    <div class="input-group custom-search-form" id="users-aol-search">
                      <input type="text" class="form-control listSearch" data-listSearch="assiningUsersToGroupUsers">
                      <span class="input-group-btn">
                        <button class="btn btn-default" type="button">
                          <span class="glyphicon glyphicon-search"></span>
                        </button>
  ...
  <div class="modal fade" id="modal-add-groups" tabindex="-1" role="dialog" aria-labelledby="Maak groepen" aria-hidden="true">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        ...
        <div class="modal-body">
        	<div class="well well-lg" id="groupBulkExcelDropArea">Drop hier een .xls (Excel) bestand. <a href="/files/exampleUsersGroups.xls" target="_blank">Een voorbeeld kan je hier downloaden</a>.</div>
        	
        	<div id=groupBulkExcelColumnselectArea>


				<table class="table table-hover" id="groupBulkExcelCheckTable">
					<thead>
						<tr><th>Gebruiker</th><th>Groep</th></tr>
						<tr><td colspan="2"><p>In welke kolom staan de gebruikersnamen en en welke kolom de groepen?</p></td></tr>
				...
				<span class="btn btn-default" id="groupBulkExcelDoTheMagic2">Link gebruikers aan groepen</span>
				</p>
        	</div>
